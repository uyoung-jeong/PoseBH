...
class FreiHandDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def _get_db(self):
        ...
        # apply dataset_channel ordering. might need to reorder sigmas in other datasets.
        dataset_channel = self.ann_info['dataset_channel'][0]
        ...
        for img_id in self.img_ids:
            ...
            for obj in objs:
                ...
                # apply dataset_channel ordering
                keypoints = keypoints[dataset_channel]
