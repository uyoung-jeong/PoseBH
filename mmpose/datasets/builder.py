...
from .samplers import DistributedSampler, MDDistributedSampler
...
def build_dataloader(dataset,
    ...
    Args:
        ...
        ratios (None or list): dataset sampling ratios.
    ...
    if dist:
        ...
        elif sampler_type == 'MDDistributedSampler':
            sampler = MDDistributedSampler(
                dataset, world_size, rank, shuffle=shuffle, seed=seed, ratios=ratios)
        shuffle = False
