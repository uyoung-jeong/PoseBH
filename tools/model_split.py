...
def parse_args():
    ...
    parser.add_argument('--datasets', type=str, default='human_animal')
...
def main():
    ...
    if args.datasets == 'human_animal':
        names = ['aic', 'mpii', 'ap10k', 'apt36k','wholebody']
        num_keypoints = [14, 16, 17, 17, 133]
    elif args.datasets == 'human_wholebody':
        names = ['aic', 'mpii', 'wholebody']
        num_keypoints = [14, 16, 133]
    elif args.datasets == '8dset':
        names = ['aic', 'mpii', 'ap10k', 'apt36k','wholebody', 'interhand', 'pw3d']
        num_keypoints = [14, 16, 17, 17, 133, 21, 24]
