...
printf "\n------------------------\n"
# evaluate aic
bash tools/dist_test.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/aic/ViTPose_huge_aic_256x192.py \
    $weight_dir/aic.pth 4
printf "\n------------------------\n"
# evaluate mpii
bash tools/dist_test.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/ViTPose_huge_mpii_256x192.py \
    $weight_dir/mpii.pth 4
printf "\n------------------------\n"
# evaluate ap10k
bash tools/dist_test.sh configs/animal/2d_kpt_sview_rgb_img/topdown_heatmap/ap10k/ViTPose_huge_ap10k_256x192.py \
...
printf "\n------------------------\n"
# evaluate ap36k
bash tools/dist_test.sh configs/animal/2d_kpt_sview_rgb_img/topdown_heatmap/apt36k/ViTPose_huge_apt36k_256x192.py \
...
bash tools/dist_test.sh configs/wholebody/2d_kpt_sview_rgb_img/topdown_heatmap/coco-wholebody/ViTPose_huge_wholebody_256x192.py \
