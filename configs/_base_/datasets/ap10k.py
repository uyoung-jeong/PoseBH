dataset_info = dict(
    ...
    skeleton_info={
        ...
        5: dict(link=('Neck', 'L_Shoulder'), id=5, color=[255, 102, 0]),
        6: dict(link=('L_Shoulder', 'L_Elbow'), id=6, color=[255, 102, 0]),
        7: dict(link=('L_Elbow', 'L_F_Paw'), id=6, color=[255, 102, 0]),
        ...
        11: dict(link=('Root of tail', 'L_Hip'), id=10, color=[255, 102, 0]),
        12: dict(link=('L_Hip', 'L_Knee'), id=11, color=[255, 102, 0]),
        13: dict(link=('L_Knee', 'L_B_Paw'), id=12, color=[255, 102, 0]),
